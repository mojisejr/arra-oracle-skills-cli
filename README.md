...
<details>
<summary>📚 <strong>40 skills installed</strong> — click to expand</summary>
...
| - |  |  |  |
| 8 | **auto-rrr** | skill | "Boundary checkpoint handoffs for Oracle |
...
| 25 | **oracle-bootstrap** | skill | Oracle bootstrap overlay |
| 26 | **preflight** | skill | "Read-only Oracle precondition checks before |
| 27 | **release-alpha** | skill | "Cut an alpha pre-release |
| 28 | **release-beta** | skill | "Cut a beta pre-release |
...
| 33 | **tidy** | skill | "Oracle inbox housekeeping |
| 34 | **trace** | skill | Find projects, code |
| 35 | **track** | skill | "Oracle orchestrator work tracking |
...
| 39 | **worktree** | skill | 'Work in an isolated git worktree |
